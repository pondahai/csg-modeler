...
![工作區裡的各種積木](docs/images/workspace.png)
...
| 一棵樹 | 一架飛機 |
|---|---|
| ![用積木堆出來的樹](docs/images/tree.png) | ![用積木堆出來的飛機](docs/images/plane.png) |

上面兩個都是純粹用內建積木擺出來的，沒有匯入任何外部模型。
檔案在 `docs/examples/`，用「檔案 ▾ → 開啟」讀進來就能自己拆開來看、改參數。
